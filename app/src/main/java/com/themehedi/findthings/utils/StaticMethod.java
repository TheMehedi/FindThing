...
public class StaticMethod {
    ...
    public static ArrayList<DivisionDataModel.Datum> divisionDataList = new ArrayList<>();
    public static ArrayList<DistrictDataModel.Datum> districtDataList = new ArrayList<>();
    public static ArrayList<AreaDataModel.Datum> areaDataList = new ArrayList<>();
}
